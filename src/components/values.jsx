        ...
        <div className="values-container">
            <div className="row justify-content-md-center">
                <div className="col-12 col-md-3">
                    <p className="values-cardTitle"><i className="icon fa-regular fa-circle-check"></i> COMPROMISO</p>
                ...
                <div className="col-12 col-md-3">
                    <p className="values-cardTitle"><i className="icon fa-regular fa-lightbulb"></i> INNOVACIÓN</p>
                ...
                <div className="col-12 col-md-3">
                    <p className="values-cardTitle"><i className="icon fa-regular fa-handshake"></i> INTEGRIDAD</p>
