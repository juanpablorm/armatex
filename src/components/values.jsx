        ...
        <div className="values-container">
            <div className="row justify-content-md-center">
                <div className="col-12 col-md-3">
                    <p className="values-cardTitle"><i class="icon fa-solid fa-circle-check"></i> COMPROMISO</p>
                ...
                <div className="col-12 col-md-3">
                    <p className="values-cardTitle"><i class="icon fa-solid fa-lightbulb"></i> INNOVACÍON</p>
                ...
                <div className="col-12 col-md-3">
                    <p className="values-cardTitle"><i class="icon fa-solid fa-handshake-simple"></i> INTEGRIDAD</p>
